...
export function VerifyGuestPaymentClient({
  ...
  return (
    <div className="w-full">
        ...
        <div className="p-4 sm:p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2.5 pt-1">
            <Button
              onClick={() => router.push("/")}
              variant="outline"
              className="h-11 rounded-xl text-xs sm:text-sm font-semibold border-gray-200 text-gray-700 hover:bg-gray-50"
            >
              Return to Store
            </Button>
            <Button
              ...
              className="h-11 bg-[#6B3FA0] hover:bg-[#5A338A] text-white text-xs sm:text-sm font-semibold rounded-xl shadow-md shadow-purple-500/20 transition-all"
            >
              {isVerifying ? (
      ...
      {/* DESKTOP LAYOUT: Exact original 2-column layout */}
      <div className="hidden md:flex flex-row gap-6 md:gap-8 items-start w-full">
